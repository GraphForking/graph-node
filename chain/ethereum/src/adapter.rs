...
use crate::Mapping;
use crate::{data_source::DataSource, data_source::DataSourceTemplate, Chain};
...
impl bc::TriggerFilter<Chain> for TriggerFilter {
    ...
    fn extend_with_template(
        ...
        for data_source in data_sources.into_iter() {
            ...
            // self.block
            //     .extend(EthereumBlockFilter::from_template(&data_source));
        }
    }
}
...
impl EthereumBlockFilter {
    ...
    pub fn from_template(data_source: &DataSourceTemplate) -> Self {
        Self {
